package com.iqmsoft.admin.bean;

import com.iqmsoft.admin.infra.model.Filter;
import com.iqmsoft.admin.model.Car;
import com.iqmsoft.admin.service.CarService;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.iqmsoft.admin.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.iqmsoft.admin.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.iqmsoft.admin.infra.model.SortOrder.DESCENDING
                            : com.iqmsoft.admin.infra.model.SortOrder.UNSORTED;
                }
